...
class Store:
    ...
    WARNING: This constructor is purely for type completion, and does not exist in the game.
    """
    def getCapacity(self, resource: str = None) -> Optional[Dict[str, int]]:
        pass

    def getFreeCapacity(self, resource: str = None) -> Optional[Dict[str, int]]:
        pass

    def getUsedCapacity(self, resource: str = None) -> Optional[Dict[str, int]]:
        pass
